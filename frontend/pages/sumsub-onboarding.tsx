        ...
        <div style={{ display: "grid", gridTemplateColumns: "1.2fr 1fr", gap: 20 }}>
          <div style={{ display: "grid", gap: 20 }}>
            ...
            <div style={cardStyle()}>
              ...
              <div style={{ color: "#9fb3d1", marginBottom: 12 }}>
...
{JSON.stringify(statusResult || { ok: false, info: "Ainda sem consulta de estado." }, null, 2)}
            ...
            <div style={cardStyle()}>
              ...
              <div style={{ color: "#dbeafe", lineHeight: 1.7 }}>
                ...
                <div style={{ marginTop: 10, color: "#9fb3d1" }}>
                  Quando tiveres o email de empresa, trocamos o sandbox por credenciais de teste apropriadas e ligamos o fluxo ao teu onboarding real.
                </div>
              </div>
            </div>
          </div>
